...
const TOOLBOX =
  ...
  'HARD LINES: never enter credentials or complete CAPTCHAs/bot checks (a human does those); never copy product code, CSS, icon files, or screenshot pixels into editable surfaces (measurements only, per docs/asset-policy.md); screenshots of logged-in sessions stay local (gitignore already covers reference/*/20*/**/screenshot*).'
